  ...
  _createClass(MyDocument, [{
    ...
    value: function render() {
      return external_react_default.a.createElement("html", {
        ...
        id: "962765224"
      }, ["div{font-size:11px;}"])), external_react_default.a.createElement("body", {
        style: {
          height: "100%",
          overflow: "hidden"
        }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                external_react_native_web_["AppRegistry"].registerComponent("Main", function () {
                  return next_document["Main"];
                });
                _AppRegistry$getAppli = external_react_native_web_["AppRegistry"].getApplication("Main"), getStyleElement = _AppRegistry$getAppli.getStyleElement;
                page = renderPage();
                ...
                return _context.abrupt("return", Object(objectSpread["a" /* default */])({}, page, {
