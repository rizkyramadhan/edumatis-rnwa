...
/* harmony default export */ __webpack_exports__["default"] = (Object(mobx_react_lite__WEBPACK_IMPORTED_MODULE_6__["observer"])(function (data) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(react_native_web__WEBPACK_IMPORTED_MODULE_8__["View"], {
    ...
    __self: this
  }), "Tambah Siswa"))), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_libs_ui_UIList__WEBPACK_IMPORTED_MODULE_4__["default"], {
    data: data.list,
    ...
    render: function render(list) {
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(react_native_web__WEBPACK_IMPORTED_MODULE_8__["View"], {
        ...
        onPress: function onPress() {
          var idx = meta.checked.indexOf(_babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_1___default()(item.id));

          if (idx >= 0) {
            meta.checked.splice(idx, 1);
          } else {
            meta.checked.push(_babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_1___default()(item.id));
          }

          console.log(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(meta.checked));
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 89
        ...
        __self: this
      }, meta.checked.indexOf(_babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_1___default()(item.id)) >= 0 ? "🗹" : "☐", " ", meta.checked.indexOf(_babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_1___default()(item.id)))), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_libs_ui_UIListItem__WEBPACK_IMPORTED_MODULE_5__["default"], {
        style: {
          flex: 1
        },
        onPress: function onPress() {
...
//# sourceMappingURL=index.js.f146a2271e2726a73daf.hot-update.js.map