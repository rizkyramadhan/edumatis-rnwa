...
/* harmony default export */ __webpack_exports__["default"] = (Object(mobx_react_lite__WEBPACK_IMPORTED_MODULE_4__["observer"])(function (data) {
  var meta = Object(mobx_react_lite__WEBPACK_IMPORTED_MODULE_4__["useObservable"])({
    checked: []
  });
  ...
  return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_native_web__WEBPACK_IMPORTED_MODULE_6__["View"], {
    ...
    render: Object(mobx_react_lite__WEBPACK_IMPORTED_MODULE_4__["observer"])(function (list) {
      var item = list.item;
      return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_native_web__WEBPACK_IMPORTED_MODULE_6__["View"], {
        style: {
          flexDirection: "row",
        ...
        __self: this
      }, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_native_web__WEBPACK_IMPORTED_MODULE_6__["TouchableOpacity"], {
        onPress: function onPress() {
          var idx = meta.checked.indexOf(item.id);

          if (idx >= 0) {
            meta.checked.splice(idx, 1);
          } else {
            meta.checked.push(item.id);
          }
        },
        __source: {
          fileName: _jsxFileName,
        ...
        __self: this
      }, meta.checked.indexOf(item.id) >= 0 ? "🗹" : "☐")), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_libs_ui_UIListItem__WEBPACK_IMPORTED_MODULE_3__["default"], {
        style: {
          flex: 1
        },
        onPress: function onPress() {
        ...
        __self: this
      }, list.index + 1), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_native_web__WEBPACK_IMPORTED_MODULE_6__["View"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 122
        },
        ...
        __self: this
      }, item.nama_murid), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_native_web__WEBPACK_IMPORTED_MODULE_6__["View"], {
        style: {
          flexDirection: "row",
          alignItems: "center"
        },
        ...
        __self: this
      }, item.is_active === "y" ? "Aktif" : "Non-Aktif", "\xA0 \u2022 \xA0"), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_native_web__WEBPACK_IMPORTED_MODULE_6__["Text"], {
        style: {
          fontSize: 13,
        ...
        __self: this
      }, item.data ? "Data diri tersedia" : "Tanpa data diri")))), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_native_web__WEBPACK_IMPORTED_MODULE_6__["View"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 142
        },
...
//# sourceMappingURL=index.js.8bb5bc76f8db99a3bd85.hot-update.js.map