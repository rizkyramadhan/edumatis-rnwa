...
/* harmony import */ var _libs_queries_user_getsetSession__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../libs/queries/user/getsetSession */ "./pages/app/libs/queries/user/getsetSession.ts");
        ...
        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Object(_libs_queries_user_getsetSession__WEBPACK_IMPORTED_MODULE_14__["getSession"])();

              case 2:
                session = _context.sent;
                _context.next = 5;
                return Object(_libs_queries_crud_rawQuery__WEBPACK_IMPORTED_MODULE_2__["default"])("{\n        kelas_murids(where: {murid_id: {_eq: ".concat(session.murid.id, "}}) {\n          kelas_id\n        }\n      }\n      "));

              case 5:
                kelas = _context.sent;
                console.log(kelas, session.murid.id);
                _context.next = 9;
...
//# sourceMappingURL=index.js.ff9409611a910eb248e8.hot-update.js.map