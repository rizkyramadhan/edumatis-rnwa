...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  if (width <= 410) {
    ...
    current = sizesm || sizexs;
  } else if (width >= 568 && width <= 767) {
    current = sizemd || sizesm || sizexs;
  } else if (width >= 768 && width <= 1023) {
    current = sizelg || sizemd || sizesm || sizexs;
  } else if (width >= 1024 && width <= 1279) {
    current = sizexl || sizelg || sizemd || sizesm || sizexs;
  } else if (width >= 1280) {
    current = sizexxl || sizexl || sizelg || sizemd || sizesm || sizexs;
  }

  console.log(width, current, sizesm, sizexs);
...
//# sourceMappingURL=index.js.ca9e4b9d0d09d87e303a.hot-update.js.map